...
Opt_Tax_Functions.o: Opt_Tax_Functions.f90 Opt_Tax_Parameters.o programfunctions.o
	gfortran -c Opt_Tax_Functions.f90 Opt_Tax_Parameters.o programfunctions.o
...
GKK_Opt_Taxes.a: GKK_Optimal_Taxes.f95 NRUTIL.o NRTYPE.o Toolbox.o Opt_Tax_Parameters.o Opt_Tax_Functions.o
	gfortran GKK_Optimal_Taxes.f95 NRUTIL.o NRTYPE.o Toolbox.o Opt_Tax_Parameters.o Opt_Tax_Functions.o -o GKK_Opt_Taxes.a
	./GKK_Opt_Taxes.a