...
!====================================================================================================
	...
	OPEN  (UNIT=1,  FILE=trim(Result_Folder)//'CE_total'  , STATUS='replace')
	OPEN  (UNIT=2,  FILE=trim(Result_Folder)//'CE_c'  , STATUS='replace')
	OPEN  (UNIT=3,  FILE=trim(Result_Folder)//'CE_cl'  , STATUS='replace')
	OPEN  (UNIT=4,  FILE=trim(Result_Folder)//'CE_cd'  , STATUS='replace')
	OPEN  (UNIT=5,  FILE=trim(Result_Folder)//'CE_h'  , STATUS='replace')
	OPEN  (UNIT=6,  FILE=trim(Result_Folder)//'CE_hl'  , STATUS='replace')
	OPEN  (UNIT=7,  FILE=trim(Result_Folder)//'CE_hd'  , STATUS='replace')
